from getNw import *
from numpy import *
def radarFields_3d(nx1,nx2,ny1,ny2,qs,qg,qh,qag,qr,qc,qv,T,prs,ncs,ncg,nch,ncag,ncr,rho,wm,z,dm_z,vt_R,vt_S,pyHB2,nz,freqs):
    nfreq=8
    ...
    for j in range(ny1,ny2):
        ...
        for i in range(nx1,nx2):
            ...
            for k in range(nz-1,-1,-1):
                ...
                kext3d[i-nx1,j-ny1,k,0]=(dpiaKu_S1+dpiaKu_S2+dpiaKu_S3+dpiaKu_S4+dpiaKu_R)/4.343
                kext3d[i-nx1,j-ny1,k,1]=(dpiaKa_S1+dpiaKa_S2+dpiaKa_S3+dpiaKa_S4+dpiaKa_R)/4.343
                kext3d[i-nx1,j-ny1,k,2]=(dpiaW_S1+dpiaW_S2+dpiaW_S3+dpiaW_S4+dpiaW_R)/4.343
                if piaKu<0:
                    stop
    ...
    return z3d,kext3d,salb3d,asym3d,v3d
